...
const taskRegistry = [
  ...
  { day: 2, label: 'Day 2', tasks: [
    { id: 'd2-t3', title: 'Task 3: List Rendering', Component: Task3_ListRendering },
    { id: 'd2-t4', title: 'Task 4: Conditional Rendering', Component: Task4_ConditionalRendering },
  ]},
  { day: 3, label: 'Day 3', tasks: [
    { id: 'd3-t5', title: 'Task 5: Counter App', Component: Task5_CounterApp },
    { id: 'd3-t6', title: 'Task 6: Toggle Switch', Component: Task6_ToggleSwitch },
  ]},
  { day: 4, label: 'Day 4', tasks: [
    { id: 'd4-t7', title: 'Task 7: Simple Form', Component: Task7_SimpleForm },
    { id: 'd4-t8', title: 'Task 8: To-Do List', Component: Task8_TodoList },
  ]},
  { day: 5, label: 'Day 5', tasks: [
    { id: 'd5-t9', title: 'Task 9: useEffect Basics', Component: Task9_UseEffectBasics },
    { id: 'd5-t10', title: 'Task 10: Fetch API Data', Component: Task10_FetchApiData },
  ]},
  { day: 6, label: 'Day 6', tasks: [
    { id: 'd6-t11', title: 'Task 11: Search/Filter', Component: Task11_SearchFilter },
    { id: 'd6-t12', title: 'Task 12: Loading & Error States', Component: Task12_LoadingErrorStates },
  ]},
  { day: 7, label: 'Day 7', tasks: [
    { id: 'd7-t13', title: 'Task 13: Lifting State Up', Component: Task13_LiftingStateUp },
    { id: 'd7-t14', title: 'Task 14: Custom Hooks', Component: Task14_CustomHooks },
  ]},
  { day: 8, label: 'Day 8', tasks: [
    { id: 'd8-t15', title: 'Task 15: Context API', Component: Task15_ContextApi },
    { id: 'd8-t16', title: 'Task 16: React Router Basics', Component: Task16_RouterBasics },
  ]},
  { day: 9, label: 'Day 9', tasks: [
    { id: 'd9-t17', title: 'Task 17: Dynamic Routes', Component: Task17_DynamicRoutes },
    { id: 'd9-t18', title: 'Task 18: Form Validation', Component: Task18_FormValidation },
  ]},
  { day: 10, label: 'Day 10', tasks: [
    { id: 'd10-t19', title: 'Task 19: Weather App', Component: Task19_WeatherApp },
    { id: 'd10-t20', title: 'Task 20: E-commerce Cart', Component: Task20_EcommerceCart },
  ]},
  { day: 11, label: 'Day 11', tasks: [
    { id: 'd11-t21', title: 'Task 21: Quiz App', Component: Task21_QuizApp },
    { id: 'd11-t22', title: 'Task 22: Recipe Search App', Component: Task22_RecipeSearchApp },
  ]},
  { day: 12, label: 'Day 12', tasks: [
    { id: 'd12-t23', title: 'Task 23: Kanban Board', Component: Task23_KanbanBoard },
  ]},
  { day: 13, label: 'Day 13', tasks: [
    { id: 'd13-t24', title: 'Task 24: State Mgmt (Zustand)', Component: Task24_StateManagement },
    { id: 'd13-t25', title: 'Task 25: Testing', Component: Task25_Testing },
    { id: 'd13-t26', title: 'Task 26: Performance', Component: Task26_Performance },
  ]},
]
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <p className="sidebar-subtitle">React practice log — all 26 tasks</p>
